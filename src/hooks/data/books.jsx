    ...
    reviews: [
      {
        ...
        rating: 4.8,
        comment:
          "Catching Fire is an intense sequel to The Hunger Games. Suzanne Collins continues to deliver a thrilling story that keeps readers hooked. The characters and the world-building are exceptional.",
        date: "2023-01-15",
      },
      {
        username: "Bookworm101",
        rating: 4.6,
        comment:
          "I couldn't put Catching Fire down! The twists and turns kept me guessing until the very end. Suzanne Collins' writing style is captivating, and the story delves deeper into the themes introduced in The Hunger Games.",
        date: "2023-01-10",
      },
    ],
    description:
    ...
    reviews: [
      {
        ...
        rating: 4.7,
        comment:
          "Mockingjay is a thrilling conclusion to the Hunger Games trilogy. Suzanne Collins masterfully concludes the story, with heart-wrenching moments and a realistic portrayal of the consequences of war.",
        date: "2023-05-01",
      },
      {
        username: "Bookworm101",
        rating: 4.4,
        comment:
          "I loved how Mockingjay tied up the loose ends and delivered an emotionally charged finale. Suzanne Collins doesn't shy away from the darkness and complexity of war, making it a powerful conclusion to the series.",
        date: "2023-04-28",
      },
    ],
    description:
